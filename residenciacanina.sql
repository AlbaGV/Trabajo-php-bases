...
--
-- Servidor: localhost
-- Tiempo de generación: 04-01-2017 a las 10:47:05
...
(1, 'Kiba', 'Pastor Aleman', '2016-11-15 23:00:00', 'Carlos', 546186165, 'ejemplo@gmail.com'),
(2, 'Simba', '', '2016-11-17 07:27:29', 'Robert', 84112861, ''),
(3, 'Luna', 'Husky', '2016-11-16 18:52:07', 'Carmen', 65961861, ''),
(44, 'Zambo', '', '2016-11-17 07:58:43', 'Alba Garcia', 697979084, 'ohallo@gmail.es');
...
--
ALTER TABLE `perros`
  MODIFY `codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
